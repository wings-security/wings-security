    ...
    <section id="about" ref={sectionRef} className="py-20 bg-background">
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <p className="sr-only">
            WINGS Security Limited is a PSA-licensed security company based in Dublin, Ireland,
            holding Private Security Authority Licence Number 14161 and CRO registration 772757.
            We provide professional static security guarding, event stewarding, and security
            services to businesses, retail centres, construction sites, corporate offices, and events
            across Ireland. All security officers are fully vetted, insured, and PSA-compliant.
            Contact us at info@wingssecurity.ie or call +353 87 369 4378.
          </p>
